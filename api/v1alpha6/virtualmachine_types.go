...
//go:generate go -C ../.. run ./pkg/gen/guestosid/guestosid.go v1alpha6 ./api/v1alpha6/zz_virtualmachine_guestosid_generated.go
...
type VirtualMachineSpec struct {
	...
	//
	// Valid policy types are: ComputePolicy, ControlledRebalancingPolicy.
