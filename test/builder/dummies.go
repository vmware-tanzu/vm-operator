...
func VirtualMachineGroupPublishRequest(name, namespace string) *vmopv1.VirtualMachineGroupPublishRequest {
	return &vmopv1.VirtualMachineGroupPublishRequest{
		...
		Spec: vmopv1.VirtualMachineGroupPublishRequestSpec{
			...
			VirtualMachines: []string{DummyVirtualMachine0Name, DummyVirtualMachine1Name},
		},
	}
}
