...
func (src *VirtualMachineWebConsoleRequest) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachineWebConsoleRequest_To_v1alpha4_VirtualMachineWebConsoleRequest(src, dst, nil)
}
...
func (dst *VirtualMachineWebConsoleRequest) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachineWebConsoleRequest_To_v1alpha2_VirtualMachineWebConsoleRequest(src, dst, nil)
}
...
func (src *VirtualMachineWebConsoleRequestList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachineWebConsoleRequestList_To_v1alpha4_VirtualMachineWebConsoleRequestList(src, dst, nil)
}
...
func (dst *VirtualMachineWebConsoleRequestList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachineWebConsoleRequestList_To_v1alpha2_VirtualMachineWebConsoleRequestList(src, dst, nil)
}
