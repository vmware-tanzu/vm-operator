...
func intgTestsDeferredCache() {
	...
	Context("DeferredInstanceStoragePVCCache", func() {
		It("should successfully initialize and watch instance storage PVCs created by the controller", func() {
			// The cache should be initialized during controller setup
			// and automatically watch PVCs that the controller creates
			...
			// This tests that the deferred cache will be able to watch it
			Eventually(func(g Gomega) {
