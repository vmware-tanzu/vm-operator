		...
		Context("disk processing", func() {
			When("VM has unmanaged disks", func() {
						...
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/disk1.vmdk",
								},
								Uuid: "disk1-uuid-123",
							},
					...
					disk2 = &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskFlatVer2BackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/disk2.vmdk",
								},
								Uuid:    "disk2-uuid-456",
				...
				It("should add volumes to VM spec and return ErrUnmanagedVols", func() {
					...
					Expect(vol1.PersistentVolumeClaim.ClaimName).To(Equal("my-vm-42ab1b3a")) // Generated from MD5 hash
					...
					Expect(vol2.PersistentVolumeClaim.ClaimName).To(Equal("my-vm-49b2c04b")) // Generated from MD5 hash
				...
				BeforeEach(func() {
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/existing-disk.vmdk",
								},
				...
				BeforeEach(func() {
					...
					fcdDisk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/fcd-disk.vmdk",
								},
								Uuid: "fcd-uuid-123",
							},
						},
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSparseVer1BackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/no-uuid-disk.vmdk",
								},
							},
						},
						CapacityInBytes: 1024 * 1024 * 1024,
				...
				BeforeEach(func() {
					...
					childDisk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/child-disk.vmdk",
								},
				...
				BeforeEach(func() {
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/nvme-disk.vmdk",
								},
				...
				BeforeEach(func() {
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/sata-disk.vmdk",
								},
		...
		Context("PVC creation and management", func() {
			When("VM has unmanaged disks and no existing PVCs", func() {
				BeforeEach(func() {
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskSeSparseBackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/disk.vmdk",
								},
								Uuid: "disk-uuid-123",
							},
						},
				...
				It("should add volumes to VM spec and return ErrUnmanagedVols", func() {
					...
					Expect(vol).ToNot(BeNil())
					Expect(vol.PersistentVolumeClaim.ClaimName).To(Equal("my-vm-3b1bcd0b"))
				})
			})
			...
			When("VM has unmanaged disk with MultiWriter sharing", func() {
				BeforeEach(func() {
					...
					disk := &vimtypes.VirtualDisk{
						VirtualDevice: vimtypes.VirtualDevice{
							...
							Backing: &vimtypes.VirtualDiskFlatVer2BackingInfo{
								VirtualDeviceFileBackingInfo: vimtypes.VirtualDeviceFileBackingInfo{
									FileName: "[datastore1] vm1/multiwriter-disk.vmdk",
								},
								Uuid:    "disk-uuid-456",
								Sharing: string(vimtypes.VirtualDiskSharingSharingMultiWriter),
							},
				...
				It("should add volumes to VM spec and return ErrUnmanagedVols", func() {
					...
					Expect(vol).ToNot(BeNil())
					Expect(vol.PersistentVolumeClaim.ClaimName).To(Equal("my-vm-62861efd"))
				})
			})
			...
			When("VM has volumes in spec and needs PVC creation", func() {
				...
				It("should create PVC and CnsRegisterVolume", func() {
					...
					Expect(crv.Spec.PvcName).To(Equal("my-vm-3b1bcd0b"))
					Expect(crv.Spec.DiskURLPath).To(Equal("[datastore1] vm1/disk.vmdk"))
				...
				BeforeEach(func() {
					...
					existingCRV := &cnsv1alpha1.CnsRegisterVolume{
						...
						Spec: cnsv1alpha1.CnsRegisterVolumeSpec{
							PvcName:     "my-vm-14c657fe",
							DiskURLPath: "[datastore1] vm1/disk.vmdk",
		...
		Context("error handling", func() {
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-error",
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-create-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-create-error",
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-crv-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-crv-error",
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-crv-get-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-crv-get-error",
			...
			When("k8sClient.Patch fails for PVC", func() {
				BeforeEach(func() {
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-patch-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-patch-error",
					...
					existingPVC := &corev1.PersistentVolumeClaim{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "my-vm-disk-uuid-patch-error",
							Namespace: vm.Namespace,
							// No OwnerReferences
						},
						Spec: corev1.PersistentVolumeClaimSpec{
			...
			When("k8sClient.Delete fails for CnsRegisterVolume cleanup", func() {
				BeforeEach(func() {
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-delete-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-delete-error",
					...
					boundPVC := &corev1.PersistentVolumeClaim{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "my-vm-disk-uuid-delete-error",
							Namespace: vm.Namespace,
							OwnerReferences: []metav1.OwnerReference{
								{
									APIVersion: vmopv1.GroupVersion.String(),
					...
					existingCRV := &cnsv1alpha1.CnsRegisterVolume{
						...
						Spec: cnsv1alpha1.CnsRegisterVolumeSpec{
							PvcName:     "my-vm-disk-uuid-delete-error",
							DiskURLPath: "[datastore1] vm1/disk.vmdk",
							AccessMode:  corev1.ReadWriteOnce,
						},
					}
			...
			When("k8sClient.DeleteAllOf fails for CnsRegisterVolume cleanup", func() {
				BeforeEach(func() {
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-delete-all-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-delete-all-error",
					...
					boundPVC := &corev1.PersistentVolumeClaim{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "my-vm-disk-uuid-delete-all-error",
							Namespace: vm.Namespace,
							OwnerReferences: []metav1.OwnerReference{
								{
									APIVersion: vmopv1.GroupVersion.String(),
					...
					vm.Spec.Volumes = []vmopv1.VirtualMachineVolume{
						{
							...
							VirtualMachineVolumeSource: vmopv1.VirtualMachineVolumeSource{
								PersistentVolumeClaim: &vmopv1.PersistentVolumeClaimVolumeSource{
									PersistentVolumeClaimVolumeSource: corev1.PersistentVolumeClaimVolumeSource{
										ClaimName: "my-vm-disk-uuid-status-update-error",
									},
									UnmanagedVolumeClaim: &vmopv1.UnmanagedVolumeClaimVolumeSource{
										Type: vmopv1.UnmanagedVolumeClaimVolumeTypeFromVM,
										Name: "disk-uuid-status-update-error",
...
func findVolumeByName(volumes []vmopv1.VirtualMachineVolume, name string) *vmopv1.VirtualMachineVolume {
	for i := range volumes {
