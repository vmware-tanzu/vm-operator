...
func (in *VirtualMachineGroupStatus) DeepCopyInto(out *VirtualMachineGroupStatus) {
	*out = *in
	if in.Placement != nil {
		...
		*out = make([]VirtualMachinePlacementStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PowerState != nil {
		...
		*out = make([]VirtualMachinePowerStateStatus, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachinePowerStateStatus) DeepCopyInto(out *VirtualMachinePowerStateStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachinePowerStateStatus.
func (in *VirtualMachinePowerStateStatus) DeepCopy() *VirtualMachinePowerStateStatus {
	if in == nil {
		return nil
	}
	out := new(VirtualMachinePowerStateStatus)
	in.DeepCopyInto(out)
	return out
}
