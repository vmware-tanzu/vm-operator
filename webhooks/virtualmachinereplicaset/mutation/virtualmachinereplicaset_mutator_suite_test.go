...
var suite = builder.NewTestSuiteForMutatingWebhookWithContext(
	...
	mutation.NewMutator,
	"default.mutating.virtualmachinereplicaset.v1alpha6.vmoperator.vmware.com")

func TestWebhook(t *testing.T) {
	suite.Register(t, "VirtualMachineReplicaSet mutation webhook suite", intgTests, unitTests)
}
