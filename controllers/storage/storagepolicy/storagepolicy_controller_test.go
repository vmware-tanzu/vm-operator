...
var _ = Describe("Reconcile", func() {
	var (
		...
		obj        *vmopv1.StoragePolicy
		objReq     ctrl.Request
		objStatus  vmopv1.StoragePolicyStatus
		namespace  string
	...
	Context("when StoragePolicy exists", func() {
		BeforeEach(func() {
			...
			objStatus = vmopv1.StoragePolicyStatus{
				DatastoreTypes: []vmopv1.DatastoreType{
					vmopv1.DatastoreTypeVMFS,
				},
				DiskProvisioningMode: vmopv1.DiskProvisioningModeThin,
				Encrypted:            false,
	...
	Context("when StoragePolicy is being deleted", func() {
		var deletingPolicyEval *vmopv1.StoragePolicy

		BeforeEach(func() {
			deletingPolicyEval = &vmopv1.StoragePolicy{
				ObjectMeta: metav1.ObjectMeta{
