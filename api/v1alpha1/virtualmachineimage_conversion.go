...
func Convert_v1alpha6_VirtualMachineImageOSInfo_To_v1alpha1_VirtualMachineImageOSInfo(
...
func convert_v1alpha1_VirtualMachineImageOSInfo_To_v1alpha6_VirtualMachineImageOSInfo(
...
func convert_v1alpha6_VirtualMachineImage_OVFProperties_To_v1alpha1_VirtualMachineImage_OVFEnv(
...
func convert_v1alpha1_VirtualMachineImage_OVFEnv_To_v1alpha6_VirtualMachineImage_OVFProperties(
...
func convert_v1alpha6_VirtualMachineImageStatusConditions_To_v1alpha1_VirtualMachineImageStatusConditions(
	...
	default:
		// BMV: This looks quite wrong in the case that the image did not
		// have a Ready condition at all.
		securityCompliantCondition = trueCondition(VirtualMachineImageProviderSecurityComplianceCondition)
		imageProviderReadyCondition = trueCondition(VirtualMachineImageProviderReadyCondition)
...
func convert_v1alpha1_VirtualMachineImageStatusConditions_To_v1alpha6_VirtualMachineImageStatusConditions(
	...
	// Condition types which are folded into the Ready condition in v1alpha6
...
func Convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha6_VirtualMachineImageSpec(
	...
	return autoConvert_v1alpha1_VirtualMachineImageSpec_To_v1alpha6_VirtualMachineImageSpec(in, out, s)
}

func Convert_v1alpha1_VirtualMachineImageStatus_To_v1alpha6_VirtualMachineImageStatus(
	in *VirtualMachineImageStatus, out *vmopv1.VirtualMachineImageStatus, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha1_VirtualMachineImageStatus_To_v1alpha6_VirtualMachineImageStatus(in, out, s); err != nil {
		return err
	}

	out.Name = in.ImageName
	out.ProviderContentVersion = in.ContentVersion
	out.Conditions = convert_v1alpha1_VirtualMachineImageStatusConditions_To_v1alpha6_VirtualMachineImageStatusConditions(in.Conditions)
	// in.ImageSupported
...
func Convert_v1alpha6_VirtualMachineImageSpec_To_v1alpha1_VirtualMachineImageSpec(
	in *vmopv1.VirtualMachineImageSpec, out *VirtualMachineImageSpec, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha6_VirtualMachineImageSpec_To_v1alpha1_VirtualMachineImageSpec(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha6_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageStatus(
	in *vmopv1.VirtualMachineImageStatus, out *VirtualMachineImageStatus, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha6_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageStatus(in, out, s); err != nil {
		return err
	}
	...
	out.Conditions = convert_v1alpha6_VirtualMachineImageStatusConditions_To_v1alpha1_VirtualMachineImageStatusConditions(in.Conditions)
...
func convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha6_VirtualMachineImageStatus(
	...
	if err := convert_v1alpha1_VirtualMachineImageOSInfo_To_v1alpha6_VirtualMachineImageOSInfo(&in.OSInfo, &out.OSInfo, s); err != nil {
		return err
	}

	if err := convert_v1alpha1_VirtualMachineImage_OVFEnv_To_v1alpha6_VirtualMachineImage_OVFProperties(in.OVFEnv, &out.OVFProperties, s); err != nil {
		return err
	}

	if err := Convert_v1alpha1_VirtualMachineImageProductInfo_To_v1alpha6_VirtualMachineImageProductInfo(&in.ProductInfo, &out.ProductInfo, s); err != nil {
		return err
	}
...
func convert_v1alpha6_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageSpec(
	...
	if err := Convert_v1alpha6_VirtualMachineImageOSInfo_To_v1alpha1_VirtualMachineImageOSInfo(&in.OSInfo, &out.OSInfo, s); err != nil {
		return err
	}

	if err := convert_v1alpha6_VirtualMachineImage_OVFProperties_To_v1alpha1_VirtualMachineImage_OVFEnv(in.OVFProperties, &out.OVFEnv, s); err != nil {
		return err
	}

	if err := Convert_v1alpha6_VirtualMachineImageProductInfo_To_v1alpha1_VirtualMachineImageProductInfo(&in.ProductInfo, &out.ProductInfo, s); err != nil {
		return err
	}
...
func convert_v1alpha6_VirtualMachineImage_VMwareSystemProperties_To_v1alpha1_VirtualMachineImageAnnotations(
...
func convert_v1alpha1_VirtualMachineImageAnnotations_To_v1alpha6_VirtualMachineImage_VMwareSystemProperties(
...
func (src *VirtualMachineImage) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha1_VirtualMachineImage_To_v1alpha6_VirtualMachineImage(src, dst, nil); err != nil {
		return err
	}

	if err := convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha6_VirtualMachineImageStatus(&src.Spec, &dst.Status, nil); err != nil {
		return err
	}

	if err := convert_v1alpha1_VirtualMachineImageAnnotations_To_v1alpha6_VirtualMachineImage_VMwareSystemProperties(
...
func (dst *VirtualMachineImage) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha6_VirtualMachineImage_To_v1alpha1_VirtualMachineImage(src, dst, nil); err != nil {
		return err
	}

	if err := convert_v1alpha6_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageSpec(&src.Status, &dst.Spec, nil); err != nil {
		return err
	}

	if err := convert_v1alpha6_VirtualMachineImage_VMwareSystemProperties_To_v1alpha1_VirtualMachineImageAnnotations(
...
func (src *VirtualMachineImageList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha1_VirtualMachineImageList_To_v1alpha6_VirtualMachineImageList(src, dst, nil)
}
...
func (dst *VirtualMachineImageList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineImageList_To_v1alpha1_VirtualMachineImageList(src, dst, nil)
}
...
func (src *ClusterVirtualMachineImage) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha1_ClusterVirtualMachineImage_To_v1alpha6_ClusterVirtualMachineImage(src, dst, nil); err != nil {
		return err
	}
...
func (dst *ClusterVirtualMachineImage) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha6_ClusterVirtualMachineImage_To_v1alpha1_ClusterVirtualMachineImage(src, dst, nil); err != nil {
		return err
	}
...
func (src *ClusterVirtualMachineImageList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha1_ClusterVirtualMachineImageList_To_v1alpha6_ClusterVirtualMachineImageList(src, dst, nil)
}
...
func (dst *ClusterVirtualMachineImageList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_ClusterVirtualMachineImageList_To_v1alpha1_ClusterVirtualMachineImageList(src, dst, nil)
}
