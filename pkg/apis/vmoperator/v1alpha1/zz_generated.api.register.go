...
var (
	vmoperatorVirtualMachineStorage = builders.NewApiResource( // Resource status endpoint
		...
		&vmoperator.VirtualMachineStrategy{builders.StorageStrategySingleton},
	)
	...
	vmoperatorVirtualMachineServiceStorage = builders.NewApiResource( // Resource status endpoint
		...
		&vmoperator.VirtualMachineServiceStrategy{builders.StorageStrategySingleton},
	)
	vmoperatorVirtualMachineSetResourcePolicyStorage = builders.NewApiResource( // Resource status endpoint
		vmoperator.InternalVirtualMachineSetResourcePolicy,
		VirtualMachineSetResourcePolicySchemeFns{},
		func() runtime.Object { return &VirtualMachineSetResourcePolicy{} },     // Register versioned resource
		func() runtime.Object { return &VirtualMachineSetResourcePolicyList{} }, // Register versioned resource list
		&vmoperator.VirtualMachineSetResourcePolicyStrategy{builders.StorageStrategySingleton},
	)
	ApiVersion = builders.NewApiVersion("vmoperator.vmware.com", "v1alpha1").WithResources(
		...
		builders.NewApiResource( // Resource status endpoint
			...
			func() runtime.Object { return &VirtualMachine{} },     // Register versioned resource
			func() runtime.Object { return &VirtualMachineList{} }, // Register versioned resource list
			&vmoperator.VirtualMachineStatusStrategy{builders.StatusStorageStrategySingleton},
		...
		builders.NewApiResource( // Resource status endpoint
			...
			func() runtime.Object { return &VirtualMachineService{} },     // Register versioned resource
			func() runtime.Object { return &VirtualMachineServiceList{} }, // Register versioned resource list
			&vmoperator.VirtualMachineServiceStatusStrategy{builders.StatusStorageStrategySingleton},
		), vmoperatorVirtualMachineSetResourcePolicyStorage,
		builders.NewApiResource( // Resource status endpoint
			vmoperator.InternalVirtualMachineSetResourcePolicyStatus,
			VirtualMachineSetResourcePolicySchemeFns{},
			func() runtime.Object { return &VirtualMachineSetResourcePolicy{} },     // Register versioned resource
			func() runtime.Object { return &VirtualMachineSetResourcePolicyList{} }, // Register versioned resource list
			&vmoperator.VirtualMachineSetResourcePolicyStatusStrategy{builders.StatusStorageStrategySingleton},
		))
...
//
// +k8s:deepcopy-gen=false
type VirtualMachineSetResourcePolicySchemeFns struct {
	builders.DefaultSchemeFns
}
