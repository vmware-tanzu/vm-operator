...
func networkInterfaceTypesFromMoVM(moVM mo.VirtualMachine) []vmopv1.VirtualMachineNetworkInterfaceType {
	if moVM.Config == nil {
		return nil
	}

	out := make([]vmopv1.VirtualMachineNetworkInterfaceType, 0, 2)
