...
// restarted by DRS after being powered off for host maintenance. The restart
// may land on any available compute resource in the cluster, not necessarily
// the host that entered maintenance mode.
