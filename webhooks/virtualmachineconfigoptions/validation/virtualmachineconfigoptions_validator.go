...
// validateNameMatchesHardwareVersion returns an error if metadata.name does
// not equal spec.hardwareVersion.
func (v validator) validateNameMatchesHardwareVersion(name, hardwareVersion string) field.ErrorList {
