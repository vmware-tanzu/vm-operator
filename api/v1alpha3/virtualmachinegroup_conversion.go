...
func (src *VirtualMachineGroup) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachineGroup_To_v1alpha5_VirtualMachineGroup(src, dst, nil)
}
...
func (dst *VirtualMachineGroup) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha5_VirtualMachineGroup_To_v1alpha3_VirtualMachineGroup(src, dst, nil)
}
...
func (src *VirtualMachineGroupList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachineGroupList_To_v1alpha5_VirtualMachineGroupList(src, dst, nil)
}
...
func (dst *VirtualMachineGroupList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha5_VirtualMachineGroupList_To_v1alpha3_VirtualMachineGroupList(src, dst, nil)
}
