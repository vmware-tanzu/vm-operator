...
// -kubebuilder:webhook:path=/default-mutate-vmoperator-vmware-com-v1alpha5-virtualmachineclass,mutating=true,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachineclasses,verbs=create;update,versions=v1alpha5,name=default.mutating.virtualmachineclass.v1alpha5.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
