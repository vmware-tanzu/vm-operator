...
func unitTestsValidateCreate() {
	...
	Context("Affinity", func() {
		...
		DescribeTable("foo", doTest,
			Entry("allow emtpy Affinity spec",
				testParams{
					setup:         func(ctx *unitValidatingWebhookContext) {},
					expectAllowed: true,
				},
			...
			Entry("disallow VM Affinity with PreferredDuringSchedulingIgnoredDuringExecution",
				testParams{
					setup: func(ctx *unitValidatingWebhookContext) {
						ctx.vm.Spec.Affinity.VMAffinity = &vmopv1.VirtualMachineAffinityVMAffinitySpec{
							PreferredDuringSchedulingIgnoredDuringExecution: make([]vmopv1.VMAffinityTerm, 1),
						}
					},
					validate: doValidateWithMsg(
						`spec.affinity.vmAffinity.preferredDuringSchedulingIgnoredDuringExecution: Forbidden: VM affinity with PreferredDuringSchedulingIgnoredDuringExecution is not allowed`),
				},
			),

			Entry("disallow VM Affinity with RequiredDuringSchedulingIgnoredDuringExecution with invalid topo key",
				testParams{
					setup: func(ctx *unitValidatingWebhookContext) {
						ctx.vm.Spec.Affinity.VMAffinity = &vmopv1.VirtualMachineAffinityVMAffinitySpec{
			...
			Entry("allow VM Affinity with RequiredDuringSchedulingIgnoredDuringExecution with valid topo key",
				testParams{
					setup: func(ctx *unitValidatingWebhookContext) {
						ctx.vm.Spec.Affinity.VMAffinity = &vmopv1.VirtualMachineAffinityVMAffinitySpec{
							RequiredDuringSchedulingIgnoredDuringExecution: []vmopv1.VMAffinityTerm{
			...
			Entry("allow VM Anti Affinity with PreferredDuringSchedulingIgnoredDuringExecution and PreferredDuringSchedulingPreferredDuringExecution",
				testParams{
					setup: func(ctx *unitValidatingWebhookContext) {
						ctx.vm.Spec.Affinity.VMAntiAffinity = &vmopv1.VirtualMachineAntiAffinityVMAffinitySpec{
			...
			Entry("disallow VM Anti Affinity with PreferredDuringSchedulingIgnoredDuringExecution and PreferredDuringSchedulingPreferredDuringExecution with unsupported fields",
				testParams{
					...
					validate: doValidateWithMsg(
						...
						`spec.affinity.vmAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].topologyKey: Unsupported value: "topology.kubernetes.io/host": supported values: "topology.kubernetes.io/zone`,
						`spec.affinity.vmAntiAffinity.preferredDuringSchedulingPreferredDuringExecution[0].topologyKey: Unsupported value: "topology.kubernetes.io/zone": supported values: "", "topology.kubernetes.io/host"`),
				},
			),
		)
	})
