...
func convert_v1alpha1_VirtualMachineImageStatusConditions_To_v1alpha3_VirtualMachineImageStatusConditions(
	...
	// Condition types which are folded into the Ready condition in v1alpha3
...
func Convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha3_VirtualMachineImageSpec(
	...
	return autoConvert_v1alpha1_VirtualMachineImageSpec_To_v1alpha3_VirtualMachineImageSpec(in, out, s)
}
...
func Convert_v1alpha1_VirtualMachineImageStatus_To_v1alpha3_VirtualMachineImageStatus(
	...
	out.Conditions = convert_v1alpha1_VirtualMachineImageStatusConditions_To_v1alpha3_VirtualMachineImageStatusConditions(in.Conditions)
	// in.ImageSupported
...
func Convert_v1alpha3_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageStatus(
	...
	out.Conditions = convert_v1alpha3_VirtualMachineImageStatusConditions_To_v1alpha1_VirtualMachineImageStatusConditions(in.Conditions)
...
func convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha3_VirtualMachineImageStatus(
	...
	if err := convert_v1alpha1_VirtualMachineImageOSInfo_To_v1alpha3_VirtualMachineImageOSInfo(&in.OSInfo, &out.OSInfo, s); err != nil {
		return err
	}

	if err := convert_v1alpha1_VirtualMachineImage_OVFEnv_To_v1alpha3_VirtualMachineImage_OVFProperties(in.OVFEnv, &out.OVFProperties, s); err != nil {
		return err
	}

	if err := Convert_v1alpha1_VirtualMachineImageProductInfo_To_v1alpha3_VirtualMachineImageProductInfo(&in.ProductInfo, &out.ProductInfo, s); err != nil {
		return err
	}
...
func convert_v1alpha3_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageSpec(
	...
	if err := Convert_v1alpha3_VirtualMachineImageOSInfo_To_v1alpha1_VirtualMachineImageOSInfo(&in.OSInfo, &out.OSInfo, s); err != nil {
		return err
	}

	if err := convert_v1alpha3_VirtualMachineImage_OVFProperties_To_v1alpha1_VirtualMachineImage_OVFEnv(in.OVFProperties, &out.OVFEnv, s); err != nil {
		return err
	}

	if err := Convert_v1alpha3_VirtualMachineImageProductInfo_To_v1alpha1_VirtualMachineImageProductInfo(&in.ProductInfo, &out.ProductInfo, s); err != nil {
		return err
	}
...
func (src *VirtualMachineImage) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := convert_v1alpha1_VirtualMachineImageSpec_To_v1alpha3_VirtualMachineImageStatus(&src.Spec, &dst.Status, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachineImage) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := convert_v1alpha3_VirtualMachineImageStatus_To_v1alpha1_VirtualMachineImageSpec(&src.Status, &dst.Spec, nil); err != nil {
		return err
	}
