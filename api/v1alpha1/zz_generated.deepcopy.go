...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineImageOVFEnv) DeepCopyInto(out *VirtualMachineImageOVFEnv) {
	*out = *in
	if in.Default != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineImageOVFEnv.
func (in *VirtualMachineImageOVFEnv) DeepCopy() *VirtualMachineImageOVFEnv {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineImageOVFEnv)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineImageSpec) DeepCopyInto(out *VirtualMachineImageSpec) {
	*out = *in
	...
	if in.OVFEnv != nil {
		...
		*out = make([]VirtualMachineImageOVFEnv, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
