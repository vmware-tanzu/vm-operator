...
// "FromImage".
func (vs *vSphereVMProvider) isUnmanagedVolumeFromImage(
...
// updateDiskDeviceFromPVC updates a disk device configuration from PVC information
...
func (vs *vSphereVMProvider) vmCreateGenConfigSpecImagePVCDataSourceRefs(
	...
	for i, deviceChange := range createArgs.ConfigSpec.DeviceChange {
		...
		if !exists || !vs.isUnmanagedVolumeFromImage(volume) {
