...
func Convert_v1alpha2_VirtualMachineClassSpec_To_v1alpha3_VirtualMachineClassSpec(
...
func Convert_v1alpha3_VirtualMachineClassSpec_To_v1alpha2_VirtualMachineClassSpec(
...
func Convert_v1alpha2_VirtualMachineClass_To_v1alpha3_VirtualMachineClass(
	in *VirtualMachineClass, out *vmopv1.VirtualMachineClass, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha2_VirtualMachineClass_To_v1alpha3_VirtualMachineClass(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha3_VirtualMachineClass_To_v1alpha2_VirtualMachineClass(
	in *vmopv1.VirtualMachineClass, out *VirtualMachineClass, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha3_VirtualMachineClass_To_v1alpha2_VirtualMachineClass(in, out, s); err != nil {
		return err
	}
