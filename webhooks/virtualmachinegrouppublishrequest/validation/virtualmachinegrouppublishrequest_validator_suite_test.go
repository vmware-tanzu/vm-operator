...
import (
	...
	"github.com/vmware-tanzu/vm-operator/webhooks/virtualmachinegrouppublishrequest/validation"
)

const (
	WebhookName = "default.validating.virtualmachinegrouppublishrequest.v1alpha4.vmoperator.vmware.com"
)
