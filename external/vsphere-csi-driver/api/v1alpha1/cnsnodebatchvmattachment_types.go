...
// +kubebuilder:resource:path=cnsnodevmbatchattachments,scope=Namespaced
...
func init() {
	objectTypes = append(objectTypes, &CnsNodeVmBatchAttachment{}, &CnsNodeVmBatchAttachmentList{})
}
