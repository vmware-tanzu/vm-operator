...
var _ = Describe("Reconcile", func() {
	var (
		...
		obj        *polv1.StoragePolicy
		objReq     ctrl.Request
		objStatus  polv1.StoragePolicyStatus
		namespace  string
	...
	JustBeforeEach(func() {
		...
		provider.GetStoragePolicyStatusFn = func(
			ctx context.Context, profileID string) (polv1.StoragePolicyStatus, error) {
	...
	Context("when StoragePolicy exists", func() {
		BeforeEach(func() {
			...
			objStatus = polv1.StoragePolicyStatus{
				Datastores: []polv1.Datastore{
					{
						ID: polv1.ManagedObjectID{
							ObjectID: "datastore-123",
						},
						Type: polv1.DatastoreTypeVMFS,
					},
				},
				DiskProvisioningMode: polv1.DiskProvisioningModeThin,
				Encrypted:            false,
	...
	Context("when StoragePolicy is being deleted", func() {
		var deletingPolicyEval *polv1.StoragePolicy

		BeforeEach(func() {
			deletingPolicyEval = &polv1.StoragePolicy{
				ObjectMeta: metav1.ObjectMeta{
