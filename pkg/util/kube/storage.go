...
func GetStoragePolicyID(
	...
	if vm.Spec.VolumeAttributesClassName != "" {
		...
		var errGetPolicyID error
		policyID, errGetPolicyID = GetStoragePolicyIDFromVolumeAttributesClass(*vac)
		if errGetPolicyID != nil {
			return "", errGetPolicyID
		}
		return policyID, nil
	}
	...
	var errGetPolicyID error
	policyID, errGetPolicyID = GetStoragePolicyIDFromStorageClass(*sc)
	if errGetPolicyID != nil {
		return "", errGetPolicyID
	}
	return policyID, nil
