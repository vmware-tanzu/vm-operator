...
// VMSchemaUpgraded returns true if the VM's schema has been upgraded to the
// current build and schema versions by checking the upgrade annotations.
func VMSchemaUpgraded(ctx context.Context, vm vmopv1.VirtualMachine) bool {
	var (
