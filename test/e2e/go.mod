...
replace k8s.io/kubelet => k8s.io/kubelet v0.35.4

replace k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.35.4

replace k8s.io/kubernetes => k8s.io/kubernetes v1.35.4
