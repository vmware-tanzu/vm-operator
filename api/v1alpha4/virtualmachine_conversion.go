...
func Convert_v1alpha6_VirtualMachineVolume_To_v1alpha4_VirtualMachineVolume(
	in *vmopv1.VirtualMachineVolume, out *VirtualMachineVolume, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineVolume_To_v1alpha4_VirtualMachineVolume(in, out, s)
}

func Convert_v1alpha6_VirtualMachineImageDiskInfo_To_v1alpha4_VirtualMachineImageDiskInfo(
	in *vmopv1.VirtualMachineImageDiskInfo, out *VirtualMachineImageDiskInfo, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha6_VirtualMachineImageDiskInfo_To_v1alpha4_VirtualMachineImageDiskInfo(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha4_VirtualMachineImageDiskInfo_To_v1alpha6_VirtualMachineImageDiskInfo(
	in *VirtualMachineImageDiskInfo, out *vmopv1.VirtualMachineImageDiskInfo, s apiconversion.Scope) error {

	return autoConvert_v1alpha4_VirtualMachineImageDiskInfo_To_v1alpha6_VirtualMachineImageDiskInfo(in, out, s)
}

func Convert_v1alpha6_VirtualMachineBootstrapCloudInitSpec_To_v1alpha4_VirtualMachineBootstrapCloudInitSpec(
	in *vmopv1.VirtualMachineBootstrapCloudInitSpec, out *VirtualMachineBootstrapCloudInitSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineBootstrapCloudInitSpec_To_v1alpha4_VirtualMachineBootstrapCloudInitSpec(in, out, s)
}

func Convert_v1alpha4_VirtualMachineCdromSpec_To_v1alpha6_VirtualMachineCdromSpec(
	in *VirtualMachineCdromSpec, out *vmopv1.VirtualMachineCdromSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha4_VirtualMachineCdromSpec_To_v1alpha6_VirtualMachineCdromSpec(in, out, s)
}

func Convert_v1alpha6_VirtualMachineCdromSpec_To_v1alpha4_VirtualMachineCdromSpec(
	in *vmopv1.VirtualMachineCdromSpec, out *VirtualMachineCdromSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineCdromSpec_To_v1alpha4_VirtualMachineCdromSpec(in, out, s)
}

func Convert_v1alpha6_VirtualMachineNetworkSpec_To_v1alpha4_VirtualMachineNetworkSpec(
...
func Convert_v1alpha6_VirtualMachineAdvancedSpec_To_v1alpha4_VirtualMachineAdvancedSpec(
	...
	return autoConvert_v1alpha6_VirtualMachineAdvancedSpec_To_v1alpha4_VirtualMachineAdvancedSpec(in, out, s)
}

// Convert_v1alpha6_VirtualMachineNetworkInterfaceSpec_To_v1alpha4_VirtualMachineNetworkInterfaceSpec drops
// fields that do not exist in v1alpha4; they are preserved via MarshalData on ConvertFrom.
func Convert_v1alpha6_VirtualMachineNetworkInterfaceSpec_To_v1alpha4_VirtualMachineNetworkInterfaceSpec(
...
// Convert_v1alpha4_VirtualMachineNetworkInterfaceSpec_To_v1alpha6_VirtualMachineNetworkInterfaceSpec converts
...
func Convert_v1alpha4_VirtualMachineNetworkInterfaceSpec_To_v1alpha6_VirtualMachineNetworkInterfaceSpec(
	in *VirtualMachineNetworkInterfaceSpec, out *vmopv1.VirtualMachineNetworkInterfaceSpec, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha4_VirtualMachineNetworkInterfaceSpec_To_v1alpha6_VirtualMachineNetworkInterfaceSpec(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha6_VirtualMachineVolumeSource_To_v1alpha4_VirtualMachineVolumeSource(
...
func Convert_v1alpha6_VirtualMachineBootstrapSpec_To_v1alpha4_VirtualMachineBootstrapSpec(
	in *vmopv1.VirtualMachineBootstrapSpec, out *VirtualMachineBootstrapSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineBootstrapSpec_To_v1alpha4_VirtualMachineBootstrapSpec(in, out, s)
}

func Convert_v1alpha6_VirtualMachineBootstrapLinuxPrepSpec_To_v1alpha4_VirtualMachineBootstrapLinuxPrepSpec(
	in *vmopv1.VirtualMachineBootstrapLinuxPrepSpec, out *VirtualMachineBootstrapLinuxPrepSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineBootstrapLinuxPrepSpec_To_v1alpha4_VirtualMachineBootstrapLinuxPrepSpec(in, out, s)
}

// Convert_v1alpha6_VirtualMachineBootstrapSysprepSpec_To_v1alpha4_VirtualMachineBootstrapSysprepSpec is an autogenerated conversion function.
func Convert_v1alpha6_VirtualMachineBootstrapSysprepSpec_To_v1alpha4_VirtualMachineBootstrapSysprepSpec(
	in *vmopv1.VirtualMachineBootstrapSysprepSpec, out *VirtualMachineBootstrapSysprepSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineBootstrapSysprepSpec_To_v1alpha4_VirtualMachineBootstrapSysprepSpec(in, out, s)
}

func Convert_v1alpha6_PersistentVolumeClaimVolumeSource_To_v1alpha4_PersistentVolumeClaimVolumeSource(
	in *vmopv1.PersistentVolumeClaimVolumeSource, out *PersistentVolumeClaimVolumeSource, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_PersistentVolumeClaimVolumeSource_To_v1alpha4_PersistentVolumeClaimVolumeSource(in, out, s)
}

func Convert_v1alpha6_VirtualMachineVolumeStatus_To_v1alpha4_VirtualMachineVolumeStatus(
...
func Convert_v1alpha6_VirtualMachineSpec_To_v1alpha4_VirtualMachineSpec(
	in *vmopv1.VirtualMachineSpec, out *VirtualMachineSpec, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha6_VirtualMachineSpec_To_v1alpha4_VirtualMachineSpec(in, out, s); err != nil {
		return err
	}
	...
	default:
		...
		for i := range in.Hardware.Cdrom {
			if err := autoConvert_v1alpha6_VirtualMachineCdromSpec_To_v1alpha4_VirtualMachineCdromSpec(
...
func Convert_v1alpha4_VirtualMachineSpec_To_v1alpha6_VirtualMachineSpec(
	in *VirtualMachineSpec, out *vmopv1.VirtualMachineSpec, s apiconversion.Scope) error {

	if err := autoConvert_v1alpha4_VirtualMachineSpec_To_v1alpha6_VirtualMachineSpec(in, out, s); err != nil {
		return err
	}
	...
	if len(in.Cdrom) > 0 {
		...
		for i := range in.Cdrom {
			if err := autoConvert_v1alpha4_VirtualMachineCdromSpec_To_v1alpha6_VirtualMachineCdromSpec(&in.Cdrom[i], &out.Hardware.Cdrom[i], s); err != nil {
				return err
			}
		}
	}
...
func Convert_v1alpha6_VirtualMachineStatus_To_v1alpha4_VirtualMachineStatus(
	in *vmopv1.VirtualMachineStatus, out *VirtualMachineStatus, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineStatus_To_v1alpha4_VirtualMachineStatus(in, out, s)
}

func Convert_v1alpha6_VirtualMachineCryptoSpec_To_v1alpha4_VirtualMachineCryptoSpec(
	in *vmopv1.VirtualMachineCryptoSpec, out *VirtualMachineCryptoSpec, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineCryptoSpec_To_v1alpha4_VirtualMachineCryptoSpec(in, out, s)
}

func Convert_v1alpha6_VirtualMachineCryptoStatus_To_v1alpha4_VirtualMachineCryptoStatus(
	in *vmopv1.VirtualMachineCryptoStatus, out *VirtualMachineCryptoStatus, s apiconversion.Scope) error {

	return autoConvert_v1alpha6_VirtualMachineCryptoStatus_To_v1alpha4_VirtualMachineCryptoStatus(in, out, s)
}
...
func Convert_common_LocalObjectRef_To_v1alpha6_VirtualMachineSnapshotReference(
...
func Convert_v1alpha6_VirtualMachineSnapshotReference_To_common_LocalObjectRef(
	...
	out.APIVersion = "vmoperator.vmware.com/v1alpha6"
...
func restore_v1alpha6_VirtualMachineVolumes(dst, src *vmopv1.VirtualMachine) {
	...
	for i := range dst.Spec.Volumes {
		...
		if srcVol, ok := srcVolMap[dstVol.Name]; ok {
			...
			dstVol.VirtualMachineSnapshotDisk = srcVol.VirtualMachineSnapshotDisk
		}
	}
}
...
func (src *VirtualMachine) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha4_VirtualMachine_To_v1alpha6_VirtualMachine(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachine) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha6_VirtualMachine_To_v1alpha4_VirtualMachine(src, dst, nil); err != nil {
		return err
	}
