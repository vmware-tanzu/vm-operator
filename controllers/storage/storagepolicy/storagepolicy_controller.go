...
func AddToManager(ctx *pkgctx.ControllerManagerContext, mgr manager.Manager) error {
	var (
		controlledType     = &polv1.StoragePolicy{}
...
// +kubebuilder:rbac:groups=vsphere.policy.vmware.com,resources=storagepolicies/status,verbs=get;list;watch;create;update;patch;delete
