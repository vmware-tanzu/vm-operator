...
func updateCurrentSnapshotStatus(
	...
	if vm.Status.CurrentSnapshot == nil ||
		vm.Status.CurrentSnapshot.APIVersion != currentSnapshot.APIVersion ||
		vm.Status.CurrentSnapshot.Kind != currentSnapshot.Kind ||
		vm.Status.CurrentSnapshot.Name != currentSnapshot.Name {
