...
type VirtualMachineGuestOptionsHardwareVersionStatus struct {
	...
	// CPUFeatureMask specifies the CPU feature compatibility masks.
...
// VirtualMachineGuestOptionsList contains a list of VirtualMachineGuestOptions objects.
type VirtualMachineGuestOptionsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualMachineGuestOptions `json:"items"`
}
...
func init() {
	objectTypes = append(
		...
		&VirtualMachineGuestOptionsList{})
}
