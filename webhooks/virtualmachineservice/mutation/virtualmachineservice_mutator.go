...
// -kubebuilder:webhook:path=/default-mutate-vmoperator-vmware-com-v1alpha3-virtualmachineservice,mutating=true,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachineservices,verbs=create;update,versions=v1alpha3,name=default.mutating.virtualmachineservice.v1alpha3.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
