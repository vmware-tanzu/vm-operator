...
import (
	...
	vmoperator "vmware.com/kubevsphere/pkg/client/informers_generated/internalversion/vmoperator"
)
...
type SharedInformerFactory interface {
	...
	Vmoperator() vmoperator.Interface
}

func (f *sharedInformerFactory) Vmoperator() vmoperator.Interface {
	return vmoperator.New(f, f.namespace, f.tweakListOptions)
}
