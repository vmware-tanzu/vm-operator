...
type VirtualMachineServiceLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.VirtualMachineService, err error)
...
// List lists all VirtualMachineServices in the indexer.
func (s *virtualMachineServiceLister) List(selector labels.Selector) (ret []*v1beta1.VirtualMachineService, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.VirtualMachineService))
	})
	return ret, err
}
...
type VirtualMachineServiceNamespaceLister interface {
	...
	Get(name string) (*v1beta1.VirtualMachineService, error)
...
// List lists all VirtualMachineServices in the indexer for a given namespace.
func (s virtualMachineServiceNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.VirtualMachineService, err error) {
...
// Get retrieves the VirtualMachineService from the indexer for a given namespace and name.
func (s virtualMachineServiceNamespaceLister) Get(name string) (*v1beta1.VirtualMachineService, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("virtualmachineservice"), name)
	}
	return obj.(*v1beta1.VirtualMachineService), nil
}
