...
type mergeOptions struct {
	...
	addSourceRef                       bool
	addStepCounter                     bool
	addStepCounterIfOnlyConditionTypes []vmopv1a1.ConditionType
	stepCounter                        int
}
...
func WithConditions(t ...vmopv1a1.ConditionType) MergeOption {
...
// IMPORTANT: This options works only while generating the Summary condition.
func WithStepCounterIfOnly(t ...vmopv1a1.ConditionType) MergeOption {
	return func(c *mergeOptions) {
...
func getFirstReason(g conditionGroups, order []vmopv1a1.ConditionType, addSourceRef bool) string {
...
func getFirstMessage(groups conditionGroups, order []vmopv1a1.ConditionType) string {
...
func getFirstCondition(g conditionGroups, priority []vmopv1a1.ConditionType) *localizedCondition {
	topGroup := g.TopGroup()
	if topGroup == nil {
		return nil
	}
