...
func (dst *VirtualMachinePublishRequest) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachinePublishRequest_To_v1alpha3_VirtualMachinePublishRequest(src, dst, nil)
}
...
func (src *VirtualMachinePublishRequestList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachinePublishRequestList_To_v1alpha4_VirtualMachinePublishRequestList(src, dst, nil)
}
