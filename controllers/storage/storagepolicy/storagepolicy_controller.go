...
func AddToManager(ctx *pkgctx.ControllerManagerContext, mgr manager.Manager) error {
	var (
		controlledType     = &vmopv1.StoragePolicy{}
...
// +kubebuilder:rbac:groups=vmoperator.vmware.com,resources=storagepolicies/status,verbs=get;list;watch;create;update;patch;delete
...
func (r *Reconciler) ReconcileNormal(
	ctx context.Context,
	obj *vmopv1.StoragePolicy) error {
