...
var (
	nil1          *vmopv1a1.Condition
	true1         = TrueCondition("true1")
	unknown1      = UnknownCondition("unknown1", "reason unknown1", "message unknown1")
	falseInfo1    = FalseCondition("falseInfo1", "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "message falseInfo1")
	falseWarning1 = FalseCondition("falseWarning1", "reason falseWarning1", vmopv1a1.ConditionSeverityWarning, "message falseWarning1")
	falseError1   = FalseCondition("falseError1", "reason falseError1", vmopv1a1.ConditionSeverityError, "message falseError1")
)
...
func TestIsMethods(t *testing.T) {
	...
	expectedSeverity := vmopv1a1.ConditionSeverityInfo
...
func TestMirror(t *testing.T) {
	foo := FalseCondition("foo", "reason foo", vmopv1a1.ConditionSeverityInfo, "message foo")
	ready := TrueCondition(vmopv1a1.ReadyCondition)
...
func TestSummary(t *testing.T) {
	...
	bar := FalseCondition("bar", "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "message falseInfo1")
	baz := FalseCondition("baz", "reason falseInfo2", vmopv1a1.ConditionSeverityInfo, "message falseInfo2")
	existingReady := FalseCondition(vmopv1a1.ReadyCondition, "reason falseError1", vmopv1a1.ConditionSeverityError, "message falseError1") // NB. existing ready has higher priority than other conditions
	...
	tests := []struct {
		...
		},
		{
			...
			want: FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "message falseInfo1"),
		},
		{
			...
			want:    FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "1 of 2 completed"),
		},
		{
		...
		},
		{
			...
			want:    FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "0 of 1 completed"),
		},
		{
			name:    "Returns ready condition with the summary of existing conditions (using WithStepCounterIf and WithStepCounterIfOnly options)",
			from:    getterWithConditions(foo, bar),
		...
		},
		{
			...
			want:    TrueCondition(vmopv1a1.ReadyCondition),
		},
		{
		...
		},
		{
			...
			want:    FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "0 of 2 completed"),
		},
		{
			name:    "Returns ready condition with the summary of selected conditions (using WithConditions and WithStepCounterIfOnly options)",
		...
		},
		{
			...
			want:    FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo2", vmopv1a1.ConditionSeverityInfo, "message falseInfo2"),
		},
		{
...
func TestAggregate(t *testing.T) {
	ready1 := TrueCondition(vmopv1a1.ReadyCondition)
	ready2 := FalseCondition(vmopv1a1.ReadyCondition, "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "message falseInfo1")
	bar := FalseCondition("bar", "reason falseError1", vmopv1a1.ConditionSeverityError, "message falseError1") // NB. bar has higher priority than other conditions
	...
	tests := []struct {
		...
		},
		{
			...
			t:    "foo",
			want: FalseCondition("foo", "reason falseInfo1", vmopv1a1.ConditionSeverityInfo, "2 of 5 completed"),
		},
	}
...
func getterWithConditions(conditions ...*vmopv1a1.Condition) Getter {
	obj := &vmopv1a1.VirtualMachine{}
	obj.SetConditions(conditionList(conditions...))
	return obj
}

func conditionList(conditions ...*vmopv1a1.Condition) vmopv1a1.Conditions {
	cs := vmopv1a1.Conditions{}
...
func haveSameStateOf(expected *vmopv1a1.Condition) types.GomegaMatcher {
