...
// +kubebuilder:webhook:verbs=create;update,path=/default-validate-vmoperator-vmware-com-v1alpha2-virtualmachinepublishrequest,mutating=false,failurePolicy=fail,groups=vmoperator.vmware.com,resources=virtualmachinepublishrequests,versions=v1alpha2,name=default.validating.virtualmachinepublishrequest.v1alpha2.vmoperator.vmware.com,sideEffects=None,admissionReviewVersions=v1;v1beta1
	...
	if apiVersion := vmpub.Spec.Source.APIVersion; apiVersion != "" {
		...
		default:
			allErrs = append(allErrs, field.NotSupported(sourcePath.Child("apiVersion"),
				apiVersion, []string{v1a1GV, v1a2GV, ""}))
		}
	}
