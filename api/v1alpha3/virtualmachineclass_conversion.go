...
func (src *VirtualMachineClass) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachineClass_To_v1alpha5_VirtualMachineClass(src, dst, nil)
}
...
func (dst *VirtualMachineClass) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha5_VirtualMachineClass_To_v1alpha3_VirtualMachineClass(src, dst, nil)
}
...
func (src *VirtualMachineClassList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachineClassList_To_v1alpha5_VirtualMachineClassList(src, dst, nil)
}
...
func (dst *VirtualMachineClassList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha5_VirtualMachineClassList_To_v1alpha3_VirtualMachineClassList(src, dst, nil)
}
