...
type VirtualMachineConfigCapability struct {
	...
	// DisableSnapshotsSupported indicates whether snapshots can be disabled.
	DisableSnapshotsSupported *bool `json:"disableSnapshotsSupported,omitempty"`

	// +optional

	// PMEMFailoverSupported indicates whether PMEM VM failover is supported.
	PMEMFailoverSupported *bool `json:"pmemFailoverSupported,omitempty"`

	// +optional

	// EHVSecureBootSupported indicates whether UEFI Secure Boot is supported for
	// EHV (Encrypted Hardware Virtualization) VMs.
	EHVSecureBootSupported *bool `json:"ehvSecureBootSupported,omitempty"`

	// +optional

	// RecordReplaySupported indicates whether record/replay is supported.
	RecordReplaySupported *bool `json:"recordReplaySupported,omitempty"`
}

// StorageClassOption describes storage class configuration options.
type StorageClassOption struct {
	// +optional

	// UnsupportedVolumes lists volume types that are not supported for this
	// virtual machine configuration.
	UnsupportedVolumes []VirtualMachineStorageClassVolumeOption `json:"unsupportedVolumes,omitempty"`
}

type VirtualMachineStorageClassVolumeOption struct {
	// +required

	// FileSystemType is the file system type of the volume.
	FileSystemType string `json:"fileSystemType"`

	// +optional

	// MajorVersion is the major version of the file system.
