...
func (r reconciler) Reconcile(
	...
	// controllers.
	unmanagedDisks := getUnmanagedDisksAndControllers(
		moVM,
		snapshotDiskKeys,
		controllerKeyToType,
		controllerKeyToBus)
	...
	addedToSpec := updateSpecWithUnmanagedDisks(
		vm,
		unmanagedDisks,
		volumeByUUID,
		controllerKeyToBus,
...
func registerUnmanagedDisks(
	...
	volumeByUUID map[string]vmopv1.VirtualMachineVolume) (bool, error) {
...
func updateSpecWithUnmanagedDisks(
	...
	volumeByUUID map[string]vmopv1.VirtualMachineVolume,
	controllerKeyToBus map[int32]*int32,
	controllerKeyToType map[int32]vmopv1.VirtualControllerType) bool {
...
func getUnmanagedDisksAndControllers(
	moVM mo.VirtualMachine,
	snapshotDiskKeys map[int32]struct{},
	controllerKeyToType map[int32]vmopv1.VirtualControllerType,
	controllerKeyToBus map[int32]*int32) []pkgutil.VirtualDiskInfo {

	var unmanagedDisks []pkgutil.VirtualDiskInfo
