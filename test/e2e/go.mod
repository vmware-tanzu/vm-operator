...
replace (
	...
	github.com/onsi/gomega => github.com/onsi/gomega v1.40.0
...
require (
	...
	github.com/vmware/govmomi v0.57.0-alpha.0.0.20260903153150-51c007bc5e1d
...
replace k8s.io/kubernetes => k8s.io/kubernetes v1.37.0
