...
// GetAndValidateVirtualMachineImageCache retrieves and validates a
...
func GetAndValidateVirtualMachineImageCache(
	ctx context.Context,
	k8sClient ctrlclient.Client,
	...
	case hardwareReadyCondition == nil,
		...
		imageType == constants.ImageTypeOVF && vmiCache.Status.OVF == nil,
		imageType == constants.ImageTypeOVF && vmiCache.Status.OVF.ProviderVersion != itemVersion:
