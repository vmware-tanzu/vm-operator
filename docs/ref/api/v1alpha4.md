...
### VirtualMachineGroupPowerStateStatus
...
If omitted, it defaults to VirtualMachine. |
| `powerState` _[VirtualMachinePowerState](#virtualmachinepowerstate)_ | PowerState describes the applied or scheduled power state for the group
member, as indicated by the AppliedAt time. |
| `appliedAt` _[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#time-v1-meta)_ | AppliedAt describes when the power state change was applied for the
group member.

Please note this could be a past time if the power state change was
already applied to the group member, or a future time if the power
state change is scheduled to be applied with a delay. |
...
| `powerState` _[VirtualMachineGroupPowerStateStatus](#virtualmachinegrouppowerstatestatus) array_ | PowerState describes the power state results for the group members. |
...
_Appears in:_
- [VirtualMachineGroupPowerStateStatus](#virtualmachinegrouppowerstatestatus)
- [VirtualMachineGroupSpec](#virtualmachinegroupspec)
- [VirtualMachineSpec](#virtualmachinespec)
- [VirtualMachineStatus](#virtualmachinestatus)
