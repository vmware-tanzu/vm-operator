...
type VirtualMachineGroupPowerStateStatus struct {
	// Name is the name of member of this group.
	Name string `json:"name"`
	...
	// PowerState describes the applied or scheduled power state for the group
	// member, as indicated by the AppliedAt time.
	PowerState VirtualMachinePowerState `json:"powerState,omitempty"`

	// +optional

	// AppliedAt describes when the power state change was applied for the
	// group member.
	//
...
type VirtualMachineGroupStatus struct {
	...
	// PowerState describes the power state results for the group members.
	PowerState []VirtualMachineGroupPowerStateStatus `json:"powerState,omitempty"`
