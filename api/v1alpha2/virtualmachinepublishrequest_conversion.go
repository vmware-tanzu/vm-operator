...
func (src *VirtualMachinePublishRequest) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachinePublishRequest_To_v1alpha3_VirtualMachinePublishRequest(src, dst, nil)
}
...
func (dst *VirtualMachinePublishRequest) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachinePublishRequest_To_v1alpha2_VirtualMachinePublishRequest(src, dst, nil)
}
...
func (src *VirtualMachinePublishRequestList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachinePublishRequestList_To_v1alpha3_VirtualMachinePublishRequestList(src, dst, nil)
}
...
func (dst *VirtualMachinePublishRequestList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachinePublishRequestList_To_v1alpha2_VirtualMachinePublishRequestList(src, dst, nil)
}
