...
- [ ] T063 [S5.b] Author `controllers/configtarget/configtarget_controller.go` — cluster-scope path: QueryConfigTarget + QueryConfigOptionDescriptor; populate status; fan out VirtualMachineConfigOptions
- [ ] T064 [S5.b] Add `pkg/providers/vsphere/environment_browser.go` — QueryConfigTarget, QueryConfigOptionDescriptor wrappers
- [ ] T065 [S5.b] Unit tests — `controllers/configtarget/configtarget_controller_test.go`
