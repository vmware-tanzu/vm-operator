...
func Set(to Setter, condition *vmopv1a1.Condition) {
...
func TrueCondition(t vmopv1a1.ConditionType) *vmopv1a1.Condition {
...
func FalseCondition(t vmopv1a1.ConditionType, reason string, severity vmopv1a1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) *vmopv1a1.Condition {
	return &vmopv1a1.Condition{
		Type:     t,
...
func UnknownCondition(t vmopv1a1.ConditionType, reason string, messageFormat string, messageArgs ...interface{}) *vmopv1a1.Condition {
	return &vmopv1a1.Condition{
		Type:    t,
...
func MarkTrue(to Setter, t vmopv1a1.ConditionType) {
	Set(to, TrueCondition(t))
}

// MarkUnknown sets Status=Unknown for the condition with the given type.
func MarkUnknown(to Setter, t vmopv1a1.ConditionType, reason, messageFormat string, messageArgs ...interface{}) {
...
func MarkFalse(to Setter, t vmopv1a1.ConditionType, reason string, severity vmopv1a1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) {
...
func SetMirror(to Setter, targetCondition vmopv1a1.ConditionType, from Getter, options ...MirrorOptions) {
...
func SetAggregate(to Setter, targetCondition vmopv1a1.ConditionType, from []Getter, options ...MergeOption) {
	Set(to, aggregate(from, targetCondition, options...))
}

// Delete deletes the condition with the given type.
func Delete(to Setter, t vmopv1a1.ConditionType) {
	if to == nil {
		return
	}

	conditions := to.GetConditions()
	newConditions := make(vmopv1a1.Conditions, 0, len(conditions))
...
func lexicographicLess(i, j *vmopv1a1.Condition) bool {
	return (i.Type == vmopv1a1.ReadyCondition || i.Type < j.Type) && j.Type != vmopv1a1.ReadyCondition
}
...
func hasSameState(i, j *vmopv1a1.Condition) bool {
