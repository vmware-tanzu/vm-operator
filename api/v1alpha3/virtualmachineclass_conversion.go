...
func (src *VirtualMachineClass) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha3_VirtualMachineClass_To_v1alpha4_VirtualMachineClass(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachineClass) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha4_VirtualMachineClass_To_v1alpha3_VirtualMachineClass(src, dst, nil); err != nil {
		return err
	}
...
func (src *VirtualMachineClassList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha3_VirtualMachineClassList_To_v1alpha4_VirtualMachineClassList(src, dst, nil)
}
...
func (dst *VirtualMachineClassList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha4_VirtualMachineClassList_To_v1alpha3_VirtualMachineClassList(src, dst, nil)
}

func Convert_v1alpha4_VirtualMachineClassSpec_To_v1alpha3_VirtualMachineClassSpec(in *vmopv1.VirtualMachineClassSpec, out *VirtualMachineClassSpec, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha4_VirtualMachineClassSpec_To_v1alpha3_VirtualMachineClassSpec(in, out, s); err != nil {
		return err
	}
