...
- [x] T071a [S5.e] E2E test (cluster-scope subset) — `test/e2e/vmservice/vmservice/configpolicy/configpolicy.go`: `ConfigTarget.status` populated from real EB and `Ready=True`; `VirtualMachineConfigOptions` fanned out per hardware version.
