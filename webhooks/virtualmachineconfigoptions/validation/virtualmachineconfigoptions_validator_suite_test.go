...
var suite = builder.NewTestSuiteForValidatingWebhookWithContext(
	...
	"default.validating.virtualmachineconfigoptions.v1alpha1.vim.vmware.com")

func TestWebhook(t *testing.T) {
	suite.Register(t, "VirtualMachineConfigOptions validation webhook suite", intgTests, unitTests)
}
