...
const (
	...
	// VirtualMachineSnapshotRevertFailedInvalidYAMLReason indicates
	// that the revert operation has failed due to invalid VM spec to revert to.
	VirtualMachineSnapshotRevertFailedInvalidYAMLReason = "VirtualMachineSnapshotRevertFailedInvalidYAML"
