...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IDEControllerStatus) DeepCopyInto(out *IDEControllerStatus) {
	*out = *in
	if in.Devices != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IDEControllerStatus.
func (in *IDEControllerStatus) DeepCopy() *IDEControllerStatus {
	if in == nil {
		return nil
	}
	out := new(IDEControllerStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NVMEControllerStatus) DeepCopyInto(out *NVMEControllerStatus) {
	*out = *in
	if in.Devices != nil {
		in, out := &in.Devices, &out.Devices
		*out = make([]VirtualDeviceStatus, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NVMEControllerStatus.
func (in *NVMEControllerStatus) DeepCopy() *NVMEControllerStatus {
	if in == nil {
		return nil
	}
	out := new(NVMEControllerStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SATAControllerStatus) DeepCopyInto(out *SATAControllerStatus) {
	*out = *in
	if in.Devices != nil {
		in, out := &in.Devices, &out.Devices
		*out = make([]VirtualDeviceStatus, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SATAControllerStatus.
func (in *SATAControllerStatus) DeepCopy() *SATAControllerStatus {
	if in == nil {
		return nil
	}
	out := new(SATAControllerStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SCSIControllerStatus) DeepCopyInto(out *SCSIControllerStatus) {
	*out = *in
	if in.Devices != nil {
		in, out := &in.Devices, &out.Devices
		*out = make([]VirtualDeviceStatus, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SCSIControllerStatus.
func (in *SCSIControllerStatus) DeepCopy() *SCSIControllerStatus {
	if in == nil {
		return nil
	}
	out := new(SCSIControllerStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineHardwareStatus) DeepCopyInto(out *VirtualMachineHardwareStatus) {
	*out = *in
	if in.IDEControllers != nil {
		in, out := &in.IDEControllers, &out.IDEControllers
		*out = make([]IDEControllerStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NVMEControllers != nil {
		in, out := &in.NVMEControllers, &out.NVMEControllers
		*out = make([]NVMEControllerStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SATAControllers != nil {
		in, out := &in.SATAControllers, &out.SATAControllers
		*out = make([]SATAControllerStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SCSIControllers != nil {
		in, out := &in.SCSIControllers, &out.SCSIControllers
		*out = make([]SCSIControllerStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
