...
const (
	// VirtualMachineGroupPublishRequestConditionSourceValid is the Type for a
	...
	VirtualMachineGroupPublishRequestConditionSourceValid = "SourceValid"

	// VirtualMachineGroupPublishRequestConditionTargetValid is the Type for a
	// VirtualMachineGroupPublishRequest resource's status condition.
	//
	// The condition's status is set to true only when the information
	// that describes the target side of the publication has been
	// validated.
	VirtualMachineGroupPublishRequestConditionTargetValid = "TargetValid"

	// VirtualMachineGroupPublishRequestConditionUploaded is the Type for a
	// VirtualMachineGroupPublishRequest resource's status condition.
	//
	// The condition's status is set to true only when all the VMs being
	// published have been successfully uploaded.
	VirtualMachineGroupPublishRequestConditionUploaded = "Uploaded"

	// VirtualMachineGroupPublishRequestConditionImageAvailable is the Type for a
	// VirtualMachineGroupPublishRequest resource's status condition.
	//
	// The condition's status is set to true only when all new
	// VirtualMachineImage resources have been realized from the published
	// VMs.
	VirtualMachineGroupPublishRequestConditionImagesAvailable = "ImagesAvailable"
