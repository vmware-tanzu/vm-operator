...
func (src *VirtualMachineImageCache) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha3_VirtualMachineImageCache_To_v1alpha5_VirtualMachineImageCache(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VirtualMachineImageCache) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	if err := Convert_v1alpha5_VirtualMachineImageCache_To_v1alpha3_VirtualMachineImageCache(src, dst, nil); err != nil {
		return err
	}
